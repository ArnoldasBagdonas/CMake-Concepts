...
void mismatchedDataTypes() {
    int num = 42;
    double result = num + 3.14; // Mixing int and double without explicit cast (High severity)
}
...
void incorrectUseOfStringSubstr() {
    ...
    std::string substr = str.substr(7, 5); // Incorrect substring length (High severity)
