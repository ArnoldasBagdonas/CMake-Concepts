...
doxygen_xml_path = os.path.abspath('/workspace/14-documentation-generation-sphinx_doxygen/build/breathe/xml')

# Add the Doxygen XML directory to the Python path
sys.path.insert(0, doxygen_xml_path)  

# Doxygen
subprocess.call('doxygen /workspace/14-documentation-generation-sphinx_doxygen/build/DoxyfileBreathe', shell=True)
